  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock your potential with NEET PYQ - Your one-stop platform for 20 years of medical entrance exam papers, unlimited attempts, and AI-driven analysis for continuous improvement."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1576091160550-2173dba999ef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtZWRpY2FsfGVufDB8fHx8MTY4OTkwOTU4Nnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock your potential with NEET PYQ - Your one-stop platform for 20 years of medical entrance exam papers, unlimited attempts, and AI-driven analysis for continuous improvement.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Customer Support" type="customer-support" />
